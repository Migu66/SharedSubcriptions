        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalDebt = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    TotalSettled = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceSpendings", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SubscriptionContexts",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionContexts", x => x.SubscriptionId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DebtHistories_UserId",
                table: "DebtHistories",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupSavings_GroupId_Year",
                table: "GroupSavings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSpendings_GroupId_ServiceName",
                table: "ServiceSpendings",
                columns: new[] { "GroupId", "ServiceName" },
                unique: true);
        }
