        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCostAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "PaymentRecordMemberQuotas",
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    IsProrrated = table.Column<bool>(type: "bit", nullable: false),
                    PaymentRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentRecordMemberQuotas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaymentRecordMemberQuotas_PaymentRecords_PaymentRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecordMemberQuotas_PaymentRecordId",
                table: "PaymentRecordMemberQuotas",
